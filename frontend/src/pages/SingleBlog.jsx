...
export default function SingleBlog() 
{
    ...
    const filtered_post = posts && posts.find((post)=> post.id == id)
          ...
          <header className="mb-4 lg:mb-6 not-format">
              <address className="flex items-center mb-6 not-italic">
                  <div className="inline-flex items-center mr-3 text-sm text-gray-900 dark:text-white">
                      <img className="mr-4 border w-16 h-16 rounded-full" src={defaultUser} alt="Jese Leos"/>
                      <div>
                          <a href="#" rel="author" className="text-xl font-bold text-gray-900 dark:text-white">{filtered_post && filtered_post.user.username}</a>
                          <p className="text-base text-gray-500 dark:text-gray-400">DevOps Developer</p>
              ...
              <h1 className="mb-4 text-3xl font-extrabold leading-tight text-gray-900 lg:mb-6 lg:text-4xl dark:text-white">{filtered_post && filtered_post.title}</h1>
          </header>
     
          <figure>
            <img src={filtered_post && filtered_post.image==="/files/undefined"? blog : config.IMAGES_URL+(filtered_post && filtered_post.image) } alt=""/>
          </figure>
          <p className='mt-4'>{filtered_post && filtered_post.description}</p>
