...
const HomePage = () => 
{
  ...
  return (
    ...
    <div className='container mx-auto lg:w-[70vw]'>
      ...
      <Link to="/events" type="button" className="text-white bg-blue-400 font-medium text-sm sm:text-lg hover:bg-blue-500 rounded-full px-8 sm:px-12 py-2.5 me-2 mb-2 dark:bg-blue-400 dark:hover:bg-blue-600 ">
        Learn More
      </Link>
      </div>
    </div>
